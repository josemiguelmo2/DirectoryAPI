...
class TestDirImplementation(unittest.TestCase):
    ...
    def test_dirinfo(self):
        ...
        id_dir = ROOT_ID
        user = ADMIN
        parent, childs = mydir.get_dir_info(id_dir, user)
    ...
    def test_adduser_readable(self):
        ...
        len_bef = len(mydir._get_readableBy(id_dir))
        mydir.add_user_readable(id_dir, user, owner)
        len_aft = len(mydir._get_readableBy(id_dir))
        self.assertEqual(len_aft, len_bef+1)
    ...
    def test_removeuser_readable(self):
        ...
        len_bef = len(mydir._get_readableBy(id_dir))
        mydir.remove_user_readable(id_dir, user, owner)
        len_aft = len(mydir._get_readableBy(id_dir))
        self.assertEqual(len_aft, len_bef-1)
    ...
    def test_adduser_writeable(self):
        ...
        len_bef = len(mydir._get_writeableBy(id_dir))
        mydir.add_user_writeable(id_dir, user, owner)
        len_aft = len(mydir._get_writeableBy(id_dir))
        self.assertEqual(len_aft, len_bef+1)
    ...
    def test_removeuser_writeable(self):
        ...
        len_bef = len(mydir._get_writeableBy(id_dir))
        mydir.remove_user_writeable(id_dir, user, owner)
        len_aft = len(mydir._get_writeableBy(id_dir))
        self.assertEqual(len_aft, len_bef-1)
    ...
    def test_add_file(self):
        ...
        len_bef = len(json.loads(mydir._get_dirFiles(id_dir)))
        mydir.add_file(id_dir, user, name, url)
        len_aft = len(json.loads(mydir._get_dirFiles(id_dir)))
        self.assertEqual(len_aft, len_bef+1)
    ...
    def test_dirfiles(self):
        ...
        id_dir = ROOT_ID
        user = ADMIN
        files = mydir.get_dir_files(id_dir, user)
    ...
    def test_fileurl(self):
        ...
        filename = "file1"
        user = ADMIN
        url = mydir.get_file_url(id_dir, filename, user)
    ...
    def test_remove_file(self):
        ...
        len_bef = len(json.loads(mydir._get_dirFiles(id_dir)))
        mydir.remove_file(id_dir, user, name)
        len_aft = len(json.loads(mydir._get_dirFiles(id_dir)))
        self.assertEqual(len_aft, len_bef-1)
